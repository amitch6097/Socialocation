...
define('tpl!views/templates/cluster_view.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="holder-title" id="holder-map-title">  <button id="holder-title-previous" >Previous</button>  <button id="holder-title-next" >Next</button></div><div class="holder-items" id="holder-map-items"></div>');}return __p.join('');}});


define('tpl!views/templates/tweet_view.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<blockquote class="twitter-tweet" width="', width ,'" height="', width ,'" data-lang="en">  <a href="', link ,'">  </a></blockquote><script async src="https://platform.twitter.com/widgets.js"  charset="utf-8"></script>');}return __p.join('');}});
...
define('MapView',[
  ...
  function(
    Backbone, MapModel, gmaps, markerclustererplus, MarkerModel, ClusterMarkerModel, ClusterView, EventMediator, MapViewTemplate
  ){
...
define('tpl!views/templates/panel_view_twitter.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1> Tweets </h1><div id="twitter-search">  <input id="tweet-search-text" type="text">  <button id="tweet-search-submit" >Submit</button></div>');}return __p.join('');}});


define('tpl!views/templates/panel_heading_view.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<button id="', uniqueName ,'-hide" data-url="', uniqueName ,'" >Hide</button><button id="', uniqueName ,'-pause" data-url="', uniqueName ,'" >Pause</button>', heading ,'');}return __p.join('');}});
...
define('tpl!views/templates/panel_view_tweet.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="tweet-container" id="twitter-', id_str ,'" data-url="', id_str ,'">  ', tweetHtml ,'</div>');}return __p.join('');}});
...
define('tpl!views/templates/panel_view_instagram.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1> Instagrams </h1><div id="instagrams-options">  <a href="/authorize_user" >Authorize</a></div>');}return __p.join('');}});
...
define('tpl!views/templates/geolocation_view.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="map-options">  <input id="map-input-search" type="text">  <button id="map-button-search">Submit</button></div>');}return __p.join('');}});
