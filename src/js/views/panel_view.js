...
define('PanelView', [
...
], function (Backbone, PanelHeadingView, EventMediator, ScrollView, PanelViewTemplate) {
    var PanelView = Backbone.View.extend({
        ...
        pause: function (e) {
            ...
            this.hidePanel(`<button class="start-button" id="${uniqueName}-start" >Start</button>`, { pause: true });
        },
        hide: function (e) {
            const uniqueName = $(e.target).attr("data-url");
            this.hidePanel(`<button class="show-button" id="${uniqueName}-show" >Show</button>`, { hide: true });
        },
