  ...
  Backbone, TweetModel, EventMediator
	...
	var TweetCollection = Backbone.Collection.extend({
      ...
      initialize: function(data){
        ...
        EventMediator.listen('maps-markers-selected', this.moveTweets, this);
    ...
    var TweetView = Backbone.View.extend({
      ...
      initialize: function(data) {
        ...
        this.template = _.template(`
          <div id="tweet-<%= cid %>">
          <p><%= cid %></p>
          <button class="tweet-link" id="<%= cid %>" data-url="<%= cid %>">Go to Location</button>
...
define('PanelView',[
  ...
  function(
    Backbone, TweetCollection, TweetsView, PanelHeadingView
  ){
    ...
    var PanelView = Backbone.View.extend({
      ...
      tweetClicked: function(e){
        ...
        //   scrollTop: $(e.currentTarget).offset().bottom
        // }, 1000)
      },
...
define('MapModel',[
  ...
  var MapModel = Backbone.Model.extend({
      ...
      updateSelected: function(toSelect){
        if(typeof toSelect === 'object'){
          let markers = toSelect.markers_;
        ...
        EventMediator.emit('maps-markers-selected', this.selected);
      },
