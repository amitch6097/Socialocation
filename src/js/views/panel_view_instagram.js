...
define('PanelViewInstagram', [
...
], function (Backbone, PanelView, PanelViewGram, InstagramCollection, SingletonView, EventMediator, PanelViewInstagramTemplate) {
    var PanelViewInstagram = PanelView.extend({
        ...
        showPanel: function (settings) {
            ...
            this.changeView(html, css, { begin: { right: "-=500" }, end: { right: "+=500" } });
        },
        hidePanel: function (newHtml, settings) {
            this.holdHtml = $(this.el).html();
            this.collection.setSettings(settings);
            let css = { height: "auto", width: "auto" };
            this.changeView(newHtml, css, { begin: { right: "-=500" }, end: { right: "+=500" } });
        },
    });
