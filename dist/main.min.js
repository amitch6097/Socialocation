...
define('tpl!views/templates/home_view.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="home-view">  <div id="map-view"></div>  <div id="geolocation-view"></div>  <div class="panel" id="panel-twitter"></div>  <div class="panel" id="panel-instagram"></div>  <div class="panel-moving" id="panel-cluster"></div></div>');}return __p.join('');}});
...
define("markerclustererplus", function(){});
...
define('MapModel', [
    ...
    'ClusterModel',
    'MarkerModel',
], function (Backbone, EventMediator, ClusterModel, MarkerModel) {
    var google;
    ;
    ...
    var MapModel = Backbone.Model.extend({
        ...
        initialize: function (data) {
            this.map = new google.maps.Map(data.mapELE, {
                zoom: 16,
                center: new google.maps.LatLng(PARSE_LAT_LNG(parseInt(data.bounds.center.lat)), PARSE_LAT_LNG(parseInt(data.bounds.center.lng))),
...
define('tpl!views/templates/popup_view.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="holder-title" id="holder-map-title">  <button id="holder-title-previous" ><</button>  <button id="holder-title-next" >></button></div><div class="holder-items" id="holder-map-items"></div>');}return __p.join('');}});
...
define('tpl!views/templates/tweet_view.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<blockquote class="twitter-tweet" width="300" data-lang="en">  <a href="', link ,'">  </a></blockquote><script async src="https://platform.twitter.com/widgets.js"  charset="utf-8"></script>');}return __p.join('');}});
...
define('tpl!views/templates/instagram_view.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="instagram" data-url="', id_str ,'" >  <img src="', link ,'" alt="', link ,'" height="300" width="300"></div>');}return __p.join('');}});
...
define('tpl!views/templates/map_view.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="map-map">  <div id="map"></div></div>');}return __p.join('');}});
...
define('tpl!views/templates/panel_view_twitter.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1> <img class="social-icon" alt="twitter icon"  src="./img/twitter-icon.png" width=60 height=50> </h1><div id="twitter-search">  <input id="tweet-search-text" placeholder="Search with #hashtags" type="text">  <button id="tweet-search-submit" >Search</button></div>');}return __p.join('');}});


define('tpl!views/templates/panel_heading_view.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<button class="hide-button" id="', uniqueName ,'-hide" data-url="', uniqueName ,'" >Hide</button><button class="pause-button" id="', uniqueName ,'-pause" data-url="', uniqueName ,'" >Pause</button>', heading ,'');}return __p.join('');}});
...
define('tpl!views/templates/panel_view.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="panel-title" id="', titleId ,'"></div><div class="panel-items" id="', itemsId ,'"></div>');}return __p.join('');}});
...
define('tpl!views/templates/panel_view_tweet.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="tweet-container" id="twitter-', id_str ,'" data-url="', id_str ,'">  <button class="button-go-to-tweet-location" id="location-', id_str ,'" data-url=', latlng ,' >Go To Location</button>  ', tweetHtml ,'</div>');}return __p.join('');}});
...
define('ItemCollection', [
    ...
    'underscore',
    'EventMediator',
], function (Backbone, EventMediator, _) {
...
define('tpl!views/templates/panel_view_gram.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="instagram-container" id="instagram-', id_str ,'" data-url="', id_str ,'"> ', instagramHtml ,'</div>');}return __p.join('');}});
...
define('tpl!views/templates/panel_view_instagram.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1> <img class="social-icon" alt="instagram icon" src="./img/instagram-icon.png" width=50 height=50> </h1><div id="instagrams-options">  <a id="instagram-authorization" href="/authorize_user" >Authorize</a></div>');}return __p.join('');}});
...
define('tpl!views/templates/geolocation_view.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="map-options">  <input id="map-input-search" placeholder="Search a location or by \'lat,lng\'" type="text">  <button id="map-button-search">Submit</button></div>');}return __p.join('');}});
