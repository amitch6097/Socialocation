...
define('MapView',[
  ...
  function(
    Backbone, MapModel, gmaps, gmapsTwo, MarkerModel
  ){
...
define('ItemModelTweet',[
  ...
  var ItemModelTweet = Backbone.Model.extend({
  ...
  Backbone, ItemModelTweet, EventMediator
	...
	var TweetCollection = Backbone.Collection.extend({
      ...
      dataLoaded: function(collection, response){
        ...
        EventMediator.emit("collection-locations-loaded", {twitter: collection.mapLocations});
...
require.config({
  paths: {
    ...
    'ItemModelTweet': 'models/tweetModel',
