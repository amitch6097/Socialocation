...
define('TweetsView',[
  ...
  function(
    Backbone, TweetView, HolderView
  ){

    var TweetsView = HolderView(TweetView);

    // CREATE A SINGLETON

    var tweetsViewInstance = undefined;

    var TweetsViewManager = function(params){
      if(tweetsViewInstance === undefined){
        tweetsViewInstance = new TweetsView(params);
      }
      return tweetsViewInstance;
    }

    return TweetsViewManager;
});
  ...
  function(
    ...
    var HomeView = Backbone.View.extend({
      ...
      initialize: function() {
        ...
        this.tweetsView = new TweetsView({el: '#tweet-holder', collection: collection});
        return this;
      },

      render: function(){
        this.$el.html('<p>Home</p><div id="tweet-holder"></div>');
