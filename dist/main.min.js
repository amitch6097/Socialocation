...
define('MapModel',[
  ...
  var MapModel = Backbone.Model.extend({
      ...
      updateSelectedCluster: function(cluster){
        ...
        this.selected = markers[0].model.id_str;
  ...
  function(
    ...
    var PanelHeadingView = Backbone.View.extend({
      ...
      initialize: function(data) {
        ...
        <button id="<%= uniqueName %>-hide" data-url="<%= uniqueName %>" >Hide</button>
        <button id="<%= uniqueName %>-pause" data-url="<%= uniqueName %>" >Pause</button>
        <%= heading %>
        `);
...
define('tpl!views/templates/base.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="panel-title" id="', titleId ,'"></div><div class="panel-items" id="', itemsId ,'"></div>');}return __p.join('');}});
...
define('PanelView',[
  ...
  'EventMediator',
  'ScrollView',
  'tpl!views/templates/base.tpl'
  ],
  function(
    Backbone, PanelHeadingView, EventMediator, ScrollView, BaseTemp
  ){
    ...
    var PanelView = Backbone.View.extend({
      ...
      pause: function(e){
        let uniqueName = $(e.target).attr("data-url");
        this.hidePanel(
...
define('PanelViewTweet',[
  ...
  function(
    Backbone, TweetView, EventMediator
  ){
    ...
    var PanelViewTweet = Backbone.View.extend({
      ...
      initialize: function(data) {
        ...
        this.superTemplate = _.template(`
          <div class="tweet-container" id="tweet-<%= id_str %>" data-url="<%= id_str %>">
            <%= tweetHtml %>
          </div>
        `);
  ...
  function(
    ...
    var PanelViewGram = Backbone.View.extend({
      ...
      initialize: function(data) {
        ...
        this.superTemplate = _.template(`
          <div class="instagram-container" id="instagram-<%= id_str %>" data-url="<%= id_str %>">
            <%= instagramHtml %>
          </div>
        `);
...
define('PanelViewInstagram',[
  ...
  function(
    Backbone, PanelView, PanelViewGram, InstagramCollection, SingletonView, EventMediator
  ){
